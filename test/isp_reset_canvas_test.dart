...
void main() {
  ...
  testWidgets('复位画布：清除画布清空全部节点', (tester) async {
    final state = await pumpView(tester);
    ...
    await tester.pump();
    await tester.pump();
    await tester.tap(find.text('清除画布'));
    await tester.pump();
    await tester.pump();
    expect(find.byType(AlertDialog), findsNothing);
