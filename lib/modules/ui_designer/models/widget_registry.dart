  ...
  static const List<WidgetTypeDef> _defs = [
    ...
    WidgetTypeDef(
      ...
      props: [
        ...
        PropDef('text', '信息文字', PropType.text, ''),
        PropDef('fontSize', '信息字号', PropType.intNum, 12, min: 6, max: 96),
        PropDef('color', '进度颜色', PropType.color, 0xFF4CAF50),
        PropDef('stripeColor', '斜条颜色', PropType.color, 0xFF81C784),
    ...
    // --- OSD widgets (embedded menu over video, key navigation) ---
    WidgetTypeDef(
      type: 'menu',
      label: '菜单列表',
      icon: Icons.segment,
      ...
      props: [
        PropDef('items', '选项(逗号分隔)', PropType.text, '项目1,项目2,项目3'),
        PropDef('selectedIndex', '选中项', PropType.intNum, 0, min: 0),
        PropDef('itemExtent', '项高度', PropType.intNum, 36, min: 12, max: 200),
        PropDef('fontSize', '字号', PropType.intNum, 16, min: 6, max: 96),
        PropDef('textColor', '文字颜色', PropType.color, 0xFFFFFFFF),
        PropDef('highlightColor', '高亮颜色', PropType.color, 0xFF1E88E5),
        PropDef('wrap', '循环', PropType.boolean, true),
      ],
      events: _menuEvents,
    ),
    WidgetTypeDef(
      ...
      defaultHeight: 28,
      props: [
        PropDef('text', '标签', PropType.text, '数值'),
        PropDef('value', '当前值', PropType.intNum, 50),
        PropDef('min', '最小值', PropType.intNum, 0),
        PropDef('max', '最大值', PropType.intNum, 100, min: 1),
        PropDef('step', '步进', PropType.intNum, 1, min: 1, max: 1000),
        PropDef('fontSize', '字号', PropType.intNum, 14, min: 6, max: 96),
        PropDef('textColor', '标签颜色', PropType.color, 0xFFFFFFFF),
        PropDef('valueColor', '数值颜色', PropType.color, 0xFF4FC3F7),
      ],
      events: _valued,
    ),
    WidgetTypeDef(
      ...
      defaultHeight: 28,
      props: [
        PropDef('text', '标签', PropType.text, '选项'),
        PropDef('options', '选项(逗号分隔)', PropType.text, '自动,手动,锁定'),
        PropDef('selectedIndex', '选中项', PropType.intNum, 0, min: 0),
        PropDef('fontSize', '字号', PropType.intNum, 14, min: 6, max: 96),
        PropDef('textColor', '标签颜色', PropType.color, 0xFFFFFFFF),
        PropDef('valueColor', '选项颜色', PropType.color, 0xFF4FC3F7),
      ],
      events: _valued,
    ),
  ];
