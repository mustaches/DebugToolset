...
class OscilloscopeState extends ChangeNotifier {
  ...
  String _lxiDeviceModel = 'MSO8000A'; // 'MSO8000A', 'MSO8000', 'MSO9000', 'DS9000', 'MHO5000', 'DHO5000', 'MHO900', 'MHO98', 'MHO2000', 'DS80000', 'DS70000', 'DHO1000', 'DHO4000', 'DS1000ZE', 'DS8000R', 'MSO7000', 'DS6000', 'MSO5000', 'MSO5000E', 'DS4000E', 'MSO4000', 'MSO2000A', 'DHO900', 'DHO800', 'DS1000Z', 'MSO1000', 'DS1000E', 'DS1000D'
  ...
  String _executeLocalScpiInternal(String command, {bool logQueryResponse = true}) {
    ...
    try {
      if (cmdName == '*IDN?') {
        ...
        if (_lxiDeviceModel == 'MSO8000') {
          res = 'RIGOL TECHNOLOGIES,MSO8000,MSO8A234500123,01.04.00.01';
        } else if (_lxiDeviceModel == 'MSO9000') {
        ...
        } else if (_lxiDeviceModel == 'MHO5000') {
          res = 'RIGOL TECHNOLOGIES,MHO5104,MHO5A987654321,01.00.00.01';
        } else if (_lxiDeviceModel == 'DHO5000') {
        ...
        } else if (_lxiDeviceModel == 'MHO2000') {
          res = 'RIGOL TECHNOLOGIES,MHO2000,MHO2A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'DS80000') {
          res = 'RIGOL TECHNOLOGIES,DS81004,DS8A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'DS70000') {
          res = 'RIGOL TECHNOLOGIES,DS70304,DS7A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'DHO1000') {
        ...
        } else if (_lxiDeviceModel == 'DS8000R') {
          res = 'RIGOL TECHNOLOGIES,DS8104R,DS8A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'MSO7000') {
          res = 'RIGOL TECHNOLOGIES,MSO7044,MSO7A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'DS6000') {
          res = 'RIGOL TECHNOLOGIES,DS6104,DS6A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'MSO5000') {
        ...
        } else if (_lxiDeviceModel == 'MSO4000') {
          res = 'RIGOL TECHNOLOGIES,MSO4054,MSO4A123456789,01.00.00.01';
        } else if (_lxiDeviceModel == 'MSO2000A') {
        ...
        } else if (_lxiDeviceModel == 'DS1000Z') {
          res = 'RIGOL TECHNOLOGIES,DS1054Z,DS1Z123456789,00.04.04';
        } else if (_lxiDeviceModel == 'MSO1000') {
          res = 'RIGOL TECHNOLOGIES,MSO1074Z,MSO1Z123456789,00.04.04';
        } else if (_lxiDeviceModel == 'DS1000E') {
          res = 'RIGOL TECHNOLOGIES,DS1102E,DS1E123456789,00.02.15';
        } else if (_lxiDeviceModel == 'DS1000D') {
          res = 'RIGOL TECHNOLOGIES,DS1102D,DS1D123456789,00.02.15';
        }
      ...
      if (cmdName.startsWith(':BODEPLOT')) {
        if (_lxiDeviceModel == 'MSO8000A' || _lxiDeviceModel == 'MSO8000' || _lxiDeviceModel == 'DS80000' || _lxiDeviceModel == 'DS70000' || _lxiDeviceModel == 'DHO1000' || _lxiDeviceModel == 'DHO4000' || _lxiDeviceModel == 'DS1000ZE' || _lxiDeviceModel == 'DS8000R' || _lxiDeviceModel == 'MSO7000' || _lxiDeviceModel == 'DS6000' || _lxiDeviceModel == 'DS4000E' || _lxiDeviceModel == 'MSO4000' || _lxiDeviceModel == 'MSO2000A' || _lxiDeviceModel == 'DS1000Z' || _lxiDeviceModel == 'MSO1000' || _lxiDeviceModel == 'DS1000E' || _lxiDeviceModel == 'DS1000D') {
