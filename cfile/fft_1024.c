 ...
 * fft_1024.c
 *
 * Basic FFT implementation with fixed window size 1024.
 * This is the baseline version used for signal spectrum analysis.
 ******************************************************************************/
 ...
 ******************************************************************************/
void fft_1024_process(float *io_buffer)
{
 ...
 ******************************************************************************/
const float *fft_1024_get_magnitude(void)
{
    return g_fft_output;
}
...
int fft_1024_demo(void)
{
    ...
    fft_1024_process(sample_buffer);
    const float *mag = fft_1024_get_magnitude();
